...
def fonctionnalites_hors_perimetre_refusees(es):
    # `search_after` etait ici jusqu'a la carte 08, `collapse` et `post_filter`
    # jusqu'a la carte 17 : les quatre sont servis, et leurs scenarios vivent
    # plus haut. Ce qui reste est ce qui est encore refuse — et un refus qui
    # n'est plus vrai est un test qui ment dans les deux sens.
