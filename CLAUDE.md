...
| `tests/compat/diff_highlight.py` | les mêmes **fragments surlignés** — pas leur nombre, leur contenu exact, balises comprises ? (207 questions, **196 identiques au caractère près, 10 refus assumés, 0 écart** ; `--calibrer` : 207/207 contre deux ES). Le même fichier lancé contre le ferrite d'avant rend **0/207** |
