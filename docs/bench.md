...
| ferrite | image `scratch` du dépôt, `docker run -p 9200:9200 -v …:/data` — **4,3 Mo compressés** au sens de [l'enveloppe](#lenveloppe-de-limage), contre 669,1 Mo pour celle d'Elasticsearch |
