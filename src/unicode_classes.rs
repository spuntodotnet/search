...
/// Categorie Mn — ce que Java appelle `NON_SPACING_MARK`.
///
/// Elle ne sert qu'a un endroit, et il est etroit : les minuscules turques
/// suppriment le point suscrit combinant qui suit un `I`, en sautant les autres
/// marques non espacantes qui se seraient glissees entre les deux. Les
/// predicats de la bibliotheque standard de Rust n'ont pas d'equivalent.
const MARQUE_NON_ESPACANTE: &[(u32, u32)] = &[
    ...
    (0x898,0x89f), (0x8ca,0x8e1), (0x8e3,0x902), (0x93a,0x93a), (0x93c,0x93c), (0x941,0x948),
    ...
    (0x1a62,0x1a62), (0x1a65,0x1a6c), (0x1a73,0x1a7c), (0x1a7f,0x1a7f), (0x1ab0,0x1abd),
    (0x1abf,0x1ace), (0x1b00,0x1b03), (0x1b34,0x1b34), (0x1b36,0x1b3a), (0x1b3c,0x1b3c),
    ...
    (0x1ced,0x1ced), (0x1cf4,0x1cf4), (0x1cf8,0x1cf9), (0x1dc0,0x1dff), (0x20d0,0x20dc),
...
/// Ce caractere est-il une marque non espacante ?
pub(crate) fn est_marque_non_espacante(c: char) -> bool {
    dans(MARQUE_NON_ESPACANTE, c)
}
